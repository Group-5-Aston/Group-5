<x-newheader>
    <section
        style="padding-top: 48px; font-family: 'Poppins', Arial, sans-serif; background-color: #ffefbe6; padding-bottom: 48px;">
        @if(session('error'))
        ...
        <div style="max-width: 400px; margin: 0 auto; text-align: center;">
            ...
            <form action="{{ route('login') }}" method="POST"
                style="background-color: #ffffff; padding: 24px; border-radius: 8px; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);">
                @csrf
                ...
                <button type="submit"
                    style="width: 100%; padding: 12px; background-color: #426b1f; color: #ffffff; border: none; border-radius: 4px; font-size: 16px; font-weight: 600; cursor: pointer;">Log
                    in</button>
            </form>
            <p style="margin-top: 16px; font-size: 14px; color: #000;">
                <a href="{{ route('password.request') }}" style="color: #426b1f; text-decoration: none;">Forgot
                    password?</a>
            </p>
