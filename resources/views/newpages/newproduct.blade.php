            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>
                            We specialize in premium pet essentials, including stylish clothes, tasty treats, and
                            everyday supplies for cats and dogs. Because they’re not just pets—they’re family. ❤️ </p>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <div class="info_form ">
                            <h5>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>
                            We are here for you! Contact our friendly support team anytime for assistance with your
                            orders or questions about our pet products.🐾 </p>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        <h6>
                            CONTACT US
