<x-newheader>
    ...
    <section style="padding-top: 48px; font-family: 'Poppins', Arial, sans-serif; background-color: #fff9e6; padding-bottom: 48px;">
        <div style="max-width: 500px; margin: 0 auto; text-align: center;">
            ...
            <form id="signupForm" action="{{route('register')}}" method="POST" style="border: 1px solid #4B7C47; padding: 24px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                @csrf

                <!-- Name box -->
                <div style="margin-bottom: 16px; text-align: left;">
                    <label for="name" style="font-size: 14px; font-weight: 600; margin-bottom: 6px; display: block; color: #000;"></label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Name*" style="width: 100%;" required>
                ...
                <div style="margin-bottom: 16px; text-align: left;">
                    ...
                    <input type="email" id="email" class="form-control" name="email" placeholder="Email*" style="width: 100%;" required>
                ...
                <div style="margin-bottom: 16px; text-align: left;">
                    ...
                    <input type="text" id="phone" class="form-control" name="phone" placeholder="Phone Number" style="width: 100%">
                ...
                <div style="margin-bottom: 16px; text-align: left;">
                    ...
                    <input type="text" id="address" class="form-control" name="address" placeholder="Address*" style="width: 100%;" required>
                ...
                <div style="margin-bottom: 16px; text-align: left;">
                    ...
                    <input type="password" id="password" class="form-control" name="password" placeholder="Password*" style="width: 100%;" required>
                ...
                <div style="margin-bottom: 16px; text-align: left;">
                    ...
                    <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="Confirm Password*" style="width: 100%;" required>
